...
from datas.loader_utils import reload_cached_features,load_dataset,para_load_dataset
EVAL_BLEU_ORDER = 4
...
def load_langpair_dataset(
    ...
    cached_examples_dir=None,
    tokenizer_dir = None,
    prepend_bos=False, load_alignments=False,
    truncate_source=False, append_source_id=False,
    need_cached_examples=False,
    ...
    if need_cached_examples:
        print("start load cached examples %s ..." %(split))
        
        cached_examples=load_dataset(os.path.join(cached_examples_dir,"cached.%s.json" %(split)))
